...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.add_new_tab(QUrl("file:///index.html"), "Главная")

        self.setWindowTitle('Core V0.4')
        ...
        browser_menu = QMenu()
        for browser in ["Chrome", "Safari", "Yandex", "Yahoo", "FireFox", "Internet Explorer"]:
    ...
    def navigate_home(self):
        self.current_browser.setUrl(QUrl("file:///index.html"))
